...
namespace FoundationCompactNumericListedDirectVerifierAcceptedTreeTaskRowsStructuralInduction
...
open FoundationCompactNumericListedDirectVerifierAcceptedUnaryTaskRowsGlobalBound
open FoundationCompactNumericListedDirectVerifierAcceptedBinaryTaskRowsGlobalBound
...
theorem
  ...
  | closed Gamma formula =>
      ...
      | leaf =>
          have hoffsetZero : offset = 0 := by
            ...
            omega
          subst offset
          exact exists_compactNumericVerifierAcceptedClosedLeafRow_at_zero
  ...
  | axm Gamma sentence =>
      ...
      | axiomCert paCertificate =>
          ...
          subst offset
          exact
            exists_compactNumericVerifierAcceptedPAAxiomLeafRow_at_zero
  ...
  | verum Gamma =>
      ...
      | leaf =>
          have hoffsetZero : offset = 0 := by
            ...
            omega
          subst offset
          exact exists_compactNumericVerifierAcceptedVerumLeafRow_at_zero
  ...
  | and Gamma leftFormula rightFormula left right ihLeft ihRight =>
      ...
      | binary leftCertificate rightCertificate =>
          ...
          exact exists_compactNumericVerifierAcceptedAndRow_at_offset
  ...
  | or Gamma leftFormula rightFormula premise ih =>
      ...
      | unary premiseCertificate =>
          ...
          exact exists_compactNumericVerifierAcceptedOrTaskRow_at_offset
      ...
      | unary premiseCertificate =>
          ...
          have hchildRows : forall childOffset,
            ...
            exact ih premiseCertificate proofSuffix certificateSuffix
              (compactNumericCombineTask 5 fields :: restTasks) values
              hchildValid hchildWeights hchildOffset
          exact exists_compactNumericVerifierAcceptedAllTaskRow_at_offset
      ...
      | unary premiseCertificate =>
          ...
          have hchildRows : forall childOffset,
            ...
            exact ih premiseCertificate proofSuffix certificateSuffix
              (compactNumericCombineTask 6 fields :: restTasks) values
              hchildValid hchildWeights hchildOffset
          exact exists_compactNumericVerifierAcceptedExsTaskRow_at_offset
      ...
      | unary premiseCertificate =>
          ...
          have hchildRows : forall childOffset,
            ...
            exact ih premiseCertificate proofSuffix certificateSuffix
              (compactNumericCombineTask 7 fields :: restTasks) values
              hchildValid hchildWeights hchildOffset
          exact exists_compactNumericVerifierAcceptedWkTaskRow_at_offset
      ...
      | unary premiseCertificate =>
          ...
          have hchildRows : forall childOffset,
            ...
            exact ih premiseCertificate proofSuffix certificateSuffix
              (compactNumericCombineTask 8 fields :: restTasks) values
              hchildValid hchildWeights hchildOffset
          exact exists_compactNumericVerifierAcceptedShiftTaskRow_at_offset
            Gamma premise premiseCertificate proofSuffix certificateSuffix
            restTasks values hvalid hweights
            (by simpa [tree, fields, childStart] using hchildRows) hoffset
      | binary leftCertificate rightCertificate =>
      ...
      | binary leftCertificate rightCertificate =>
          ...
          have hrightRows : forall childOffset,
            ...
            exact ihRight rightCertificate proofSuffix certificateSuffix
              (combineTask :: restTasks) (leftResult :: values) hrightValid
              hrightWeights hchildOffset
          exact exists_compactNumericVerifierAcceptedCutRow_at_offset Gamma
...
end FoundationCompactNumericListedDirectVerifierAcceptedTreeTaskRowsStructuralInduction
