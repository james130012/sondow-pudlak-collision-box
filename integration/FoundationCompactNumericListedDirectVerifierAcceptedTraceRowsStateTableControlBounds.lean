...
import integration.FoundationCompactNumericListedDirectVerifierAcceptedTerminalRowsStateTableControlBounds
import integration.FoundationCompactNumericListedDirectVerifierAcceptedTreeTaskRowsStateTableControlBounds
...
namespace FoundationCompactNumericListedDirectVerifierAcceptedTraceRowsStateTableControlBounds
...
open FoundationCompactNumericListedDirectVerifierAcceptedTreeTaskRowsStateTableControlBounds
...
theorem
    exists_canonicalAcceptedCheckedStepRow_at_offset_with_globalControlBound_of_taskRows
  ...
  · by_cases hfinish : offset = taskSteps
    · subst offset
      rcases exists_canonicalAcceptedFinishCheckedStepRow_with_globalControlBound
    ...
    · have hterminal : taskSteps + 1 <= offset := by omega
      rcases exists_canonicalAcceptedHaltedCheckedStepRow_with_globalControlBound
...
theorem exists_canonicalAcceptedCheckedStepRow_at_offset_with_globalControlBound
    (tree : ListedCheckedPAProofTree)
    (certificate : StructuralValidityCertificate)
    (hvalid : listedCertificateValid tree certificate)
...
end FoundationCompactNumericListedDirectVerifierAcceptedTraceRowsStateTableControlBounds
