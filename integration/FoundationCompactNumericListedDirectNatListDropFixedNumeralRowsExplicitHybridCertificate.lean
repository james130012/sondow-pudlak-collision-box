...
namespace FoundationCompactNumericListedDirectNatListDropFixedNumeralRowsExplicitHybridCertificate
...
@[simp] private theorem free_closedShift_shortBinaryNumeralTerm
  ...
  have h := Semiterm.rew_eq_of_funEqOn leftRewriting rightRewriting
    (shortBinaryNumeralTerm value) (fun coordinate => Fin.elim0 coordinate)
    (fun coordinate hcoordinate => by
      have : coordinate ∈ (shortBinaryNumeralTerm value).freeVariables := hcoordinate
      rw [shortBinaryNumeralTerm_freeVariables_eq_empty] at this
      simp at this)
  simpa [leftRewriting, rightRewriting, Rew.comp_app] using h

@[simp] private theorem shift_shortBinaryNumeralTerm (value : Nat) :
    Rew.shift (shortBinaryNumeralTerm value) = shortBinaryNumeralTerm value := by
  simp
...
def compactAdditiveNatListDropFixedNumeralRowsTerminal
...
def compactAdditiveNatListDropFixedNumeralRowsBody
    (tokenTable width tokenCount sourceBoundary targetBoundary consumed : Nat) :
    ArithmeticSemiformula Nat 1 :=
  (((((compactAdditiveNatListDropFixedNumeralRowsTerminal tokenTable width tokenCount
...
def compactAdditiveNatListDropFixedNumeralRowsExplicitFormula
    (tokenTable width tokenCount sourceBoundary sourceCount targetBoundary targetCount
      consumed : Nat) :
    ValuationFormula :=
...
theorem compactAdditiveNatListDropFixedNumeralRowsClosedFormula_alignment
    (tokenTable width tokenCount sourceBoundary sourceCount targetBoundary targetCount
      consumed : Nat) :
    compactAdditiveNatListDropFixedNumeralRowsClosedFormula tokenTable width tokenCount
      ...
      compactAdditiveNatListDropFixedNumeralRowsExplicitFormula tokenTable width tokenCount
  ...
  unfold compactAdditiveNatListDropRowsDef
...
structure CompactAdditiveNatListDropRowData
    (tokenTable width tokenCount sourceBoundary targetBoundary consumed index : Nat) where
  sourceLeft : Nat
  sourceRight : Nat
  targetLeft : Nat
  targetRight : Nat
...
def compactAdditiveNatListDropFixedNumeralRowsBranchTerminal
    (tokenTable width tokenCount sourceBoundary targetBoundary consumed : Nat) :
...
theorem compactAdditiveNatListDropFixedNumeralRowsTerminal_free_alignment
    (tokenTable width tokenCount sourceBoundary targetBoundary consumed : Nat) :
    Rewriting.free (compactAdditiveNatListDropFixedNumeralRowsTerminal tokenTable width tokenCount
      sourceBoundary targetBoundary consumed) =
      compactAdditiveNatListDropFixedNumeralRowsBranchTerminal tokenTable width tokenCount
...
theorem compactAdditiveNatListDropFixedNumeralRowsBody_free_alignment
    (tokenTable width tokenCount sourceBoundary targetBoundary consumed : Nat) :
    Rewriting.free (compactAdditiveNatListDropFixedNumeralRowsBody tokenTable width tokenCount
      sourceBoundary targetBoundary consumed) =
  ...
  calc
    Rewriting.free (compactAdditiveNatListDropFixedNumeralRowsBody tokenTable width tokenCount
      ...
      simp [Rew.q_free, closedShift,
        compactAdditiveNatListDropFixedNumeralRowsTerminal_free_alignment]
...
theorem compactAdditiveNatListDropFixedNumeralRowsBranchTerminal_substitution_alignment
...
noncomputable def compactAdditiveNatListDropFixedNumeralRowsBranchCertificate
      ...
      (CheckedHybridValuationBoundedFormulaCertificate.conjunction
        ...
        (CheckedHybridValuationBoundedFormulaCertificate.conjunction
          ...
          (compactAdditiveAtomicRowEqAtValuationExplicitHybridCertificate valuation
            (shortBinaryNumeralTerm tokenTable) (shortBinaryNumeralTerm width)
              (shortBinaryNumeralTerm tokenCount) (shortBinaryNumeralTerm data.sourceLeft)
  ...
  let terminal : HybridCertificate valuation
    ...
    .cast (by
      rw [hvalueTerms]
      exact (compactAdditiveNatListDropFixedNumeralRowsBranchTerminal_substitution_alignment
  ...
  exact .cast (compactAdditiveNatListDropFixedNumeralRowsBody_free_alignment tokenTable width
...
noncomputable def
    ...
    CheckedHybridValuationUniversalBranches zeroValuation
      (compactAdditiveNatListDropFixedNumeralRowsBody tokenTable width tokenCount
        sourceBoundary targetBoundary consumed) targetCount :=
  buildExplicitHybridUniversalBranches targetCount (fun index hindex =>
    compactAdditiveNatListDropFixedNumeralRowsBranchCertificate
      tokenTable width tokenCount sourceBoundary targetBoundary consumed index
      (rows ⟨index, hindex⟩))

theorem compactAdditiveNatListDropFixedNumeralRowsShortNumeralBound_eq_targetCount
    (targetCount : Nat) :
...
noncomputable def compactAdditiveNatListDropFixedNumeralRowsDirectHybridBranches
    (tokenTable width tokenCount sourceBoundary targetBoundary targetCount
      consumed : Nat)
    (rows : (index : Fin targetCount) -> CompactAdditiveNatListDropRowData
      tokenTable width tokenCount sourceBoundary targetBoundary consumed index) :
...
noncomputable def compactAdditiveNatListDropFixedNumeralRowsUniversalCertificate
  ...
  let body := compactAdditiveNatListDropFixedNumeralRowsBody tokenTable width tokenCount
    sourceBoundary targetBoundary consumed
...
noncomputable def compactAdditiveNatListDropFixedNumeralRowDataOfGraph
...
noncomputable def
  ...
  let parts := CheckedHybridValuationBoundedFormulaCertificate.conjunction countBound
    (CheckedHybridValuationBoundedFormulaCertificate.conjunction countEq
      (compactAdditiveNatListDropFixedNumeralRowsUniversalCertificate tokenTable width tokenCount
...
noncomputable def compactAdditiveNatListDropFixedNumeralRowsExplicitHybridCertificateOfGraph
    (tokenTable width tokenCount sourceBoundary sourceCount targetBoundary targetCount consumed : Nat)
    (hgraph : CompactAdditiveNatListDropRows tokenTable width tokenCount sourceBoundary
      sourceCount targetBoundary targetCount consumed) :
    HybridCertificate zeroValuation
      (compactAdditiveNatListDropFixedNumeralRowsClosedFormula tokenTable width tokenCount
        sourceBoundary sourceCount targetBoundary targetCount consumed) := by
  let rows : (index : Fin targetCount) -> CompactAdditiveNatListDropRowData
      tokenTable width tokenCount sourceBoundary targetBoundary consumed index :=
    compactAdditiveNatListDropFixedNumeralRowDataOfGraph tokenTable width
      ...
      hgraph
  exact compactAdditiveNatListDropFixedNumeralRowsFromRowDataExplicitHybridCertificate
    tokenTable width tokenCount sourceBoundary sourceCount targetBoundary
    targetCount consumed hgraph.1 hgraph.2.1 rows

#print axioms compactAdditiveNatListDropFixedNumeralRowsClosedFormula_alignment
#print axioms compactAdditiveNatListDropFixedNumeralRowsExplicitHybridCertificateOfGraph

end FoundationCompactNumericListedDirectNatListDropFixedNumeralRowsExplicitHybridCertificate
